...
class CategoryPageState extends State<CategoryPage> {
  ...
  Recipe emptyRecipe = new Recipe(recipeName: 'Список улюблених категорій поки ще пустий');
